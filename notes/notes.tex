...
\begin{paracol}{2}
	...
	\note{As shown in Snippet 5.1, we pass an object to \href{https://numpy.org/doc/stable/reference/generated/numpy.array.html#numpy.array}{\texttt{numpy.array}}. If the object we pass is a scalar, a 0-dimensional array containing object is returned (line ).}
\end{paracol}
...
\begin{paracol}{2}
	...
	\note{\texttt{ndarrays} have been designed --- and tuned over time --- with flexibility and efficiency in mind. For example,\href{https://numpy.org/doc/stable/reference/arrays.ndarray.html}{\texttt{ndarrays}} allow to carry out computations on arrays with a syntax similar to scalar values (see Snippet 5.2). At the same time, \href{https://numpy.org/doc/stable/reference/arrays.ndarray.html}{\texttt{ndarrays}} can be deployed proficiently in the context of `big data'}
\end{paracol}

\begin{paracol}{2}
	\question{\raggedright How do we use \texttt{ndarrays}?}
	\note{}
\end{paracol}
...
\section{Univeresal Functions in NumPy}
